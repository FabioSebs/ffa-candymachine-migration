<<<<<<< HEAD:metaplex/js/packages/candy-machine-ui/src/Home.tsx
import { useEffect, useMemo, useState, useCallback, useContext } from 'react';
=======
import { useCallback, useEffect, useMemo, useState } from 'react';
>>>>>>> upstream/master:js/packages/candy-machine-ui/src/Home.tsx
...
const Home = (props: HomeProps) => {
  ...
  return (
    <Container style={{ marginTop: 0 , position: "relative"}} className="w-full h-full">
      ...
      <FAQ />
      <Footer />
      <Container style={{ position: 'absolute', width:'450px'}} className={`mintButton ${cookies.time ? "opacity-100": "opacity-0 &hover:disabled"}`}>
        <Paper
          style={{
            padding: 24,
            paddingBottom: 10,
